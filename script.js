...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM fully loaded and parsed');  // Log to confirm script execution
    ...
    fetch('games.json')
        ...
        .then(games => {
            console.log('Games data loaded:', games);  // Log the games data
            const randomGame = games[Math.floor(Math.random() * games.length)];
            let attempts = 0;
            ...
            submitGuessButton.addEventListener('click', () => {
                ...
                attempts++;
                console.log('User guess:', userGuess);  // Log user guess
